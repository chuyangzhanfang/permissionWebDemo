package com.jiantou.demo.shiro;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.jiantou.demo.mapper.SysMenuMapper;
...
public class UserRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(
        ...
        SysUser user = sysUserMapper.selectOne(new QueryWrapper<SysUser>().eq("username", token.getUsername()));
        //账号不存在
        if(user == null) {
